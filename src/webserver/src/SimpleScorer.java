...
//	public float score() {
//		assert doc != -1;
//		//System.out.println("norm:" + getSimilarity().decodeNormValue(norms[doc]));
//		//TODO: implements BM25 ranking algorithm
//		float numTerms = 1.f / getSimilarity().decodeNormValue(norms[doc]);
//		numTerms *= numTerms;
//		System.out.println("doc, norm:" + doc + " " + numTerms);
//		float R = freq * (K1+1) / (freq + K1 * (1 - b + b * numTerms / avgLength));
//		return idf * R;
//	}
//
//	/**
